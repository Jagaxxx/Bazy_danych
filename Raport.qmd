...
Z kolei przychód uzyskany ze sprzedaży bilteów wycieczek wyniósł `r format(suma_cena_biletow, big.mark = " ", scientific = FALSE)` SpaceCoinów. Natomiast z racji prowizji na ubezpieczenia `r format(suma_prowizji, big.mark = " ", scientific = FALSE)` SpaceCoinów. Łączny przychód to `r format(suma_przychod, big.mark = " ", scientific = FALSE)` SpaceCoinów. Na tej podstawie obliczono zysk firmy, który wyniósł `r format(zysk_firmy, big.mark = " ", scientific = FALSE)` SpaceCoinów.
